...
#SBATCH --job-name=train-bartwikikp-kptimes-fewshot10k-step10k
#SBATCH --output=slurm_output/train-bartwikikp-kptimes-fewshot10k-step10k.out
#SBATCH --nodes=1
