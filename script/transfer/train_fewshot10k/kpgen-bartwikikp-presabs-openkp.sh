...
#SBATCH --job-name=train-bartwikikp-openkp-fewshot10k-step10k
#SBATCH --output=slurm_output/train-bartwikikp-openkp-fewshot10k-step10k.out
#SBATCH --nodes=1
