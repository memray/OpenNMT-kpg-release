...
#SBATCH --job-name=train-bartwikikp-kp20k-fewshot10k-step10k
#SBATCH --output=slurm_output/train-bartwikikp-kp20k-fewshot10k-step10k.out
#SBATCH --nodes=1
