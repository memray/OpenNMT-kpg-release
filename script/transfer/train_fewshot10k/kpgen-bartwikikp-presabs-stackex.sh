...
#SBATCH --job-name=train-bartwikikp-stackex-fewshot10k-step10k
#SBATCH --output=slurm_output/train-bartwikikp-stackex-fewshot10k-step10k.out
#SBATCH --nodes=1
