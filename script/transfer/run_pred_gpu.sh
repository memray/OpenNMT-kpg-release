...
#datasets=(kp20k kp20k_valid2k kptimes kptimes_valid2k jptimes jptimes_valid2k duc openkp openkp_valid2k stackex stackex_valid2k)
...
step_base=300000
datasets=(kptimes kptimes_valid2k jptimes jptimes_valid2k duc openkp openkp_valid2k stackex stackex_valid2k)

for dataset in "${datasets[@]}"
do
    exp_root_dir="/zfs1/hdaqing/rum20/kp/fairseq-kpg/exps/kp/transformer_presabs_kp20k"
    EXP_NAME="transfer-$task_args-$dataset-bs$beam_size"
