...
#SBATCH --job-name=train-verbatim_prepend-magkp-transformer-L2H4-DIM128-LR05-DO00-TTTT-TFB1
#SBATCH --output=slurm_output/train-verbatim_prepend-magkp-transformer-L2H4-DIM128-LR05-DO00-TTTT-TFB1.out
#SBATCH --nodes=1
