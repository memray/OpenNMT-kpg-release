...
#SBATCH --job-name=train-no_sort-kp20k-rnn-DIM150-EMB100-LR005-DO00-TFFF-TFB1
#SBATCH --output=slurm_output/train-no_sort-kp20k-rnn-DIM150-EMB100-LR005-DO00-TFFF-TFB1.out
#SBATCH --nodes=1
