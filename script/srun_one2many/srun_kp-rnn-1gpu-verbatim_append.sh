...
#SBATCH --job-name=train-verbatim_append-kp20k-rnn-DIM150-EMB100-LR005-DO00-TTTF-TFB1
#SBATCH --output=slurm_output/train-verbatim_append-kp20k-rnn-DIM150-EMB100-LR005-DO00-TTTF-TFB1.out
#SBATCH --nodes=1
