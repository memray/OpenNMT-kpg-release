...
#SBATCH --job-name=train-magkp-rnn-DIM150-EMB100-LR005-DO00-TTTT-TFB1
#SBATCH --output=slurm_output/train-magkp-rnn-DIM150-EMB100-LR005-DO00-TTTT-TFB1.out
#SBATCH --nodes=1
...
export EXP_NAME="$DATA_NAME-$TOKEN_NAME-$TARGET_TYPE-rnn-BS$BatchSize-Layer$LAYER-Dim$HIDDEN-Emb$EMBED-Dropout$Dropout-Copy$Copy-Cov$Cov-Cont$ContextGate-IF$InputFeed"
