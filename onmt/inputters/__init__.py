...
str2reader = {
    "text": TextDataReader, "img": ImageDataReader, "audio": AudioDataReader, "keyphrase": KeyphraseDataReader}
str2dataset = {
    "text": Dataset, "img": Dataset, "audio": Dataset, "keyphrase": KeyphraseDataset}
str2sortkey = {
    'text': text_sort_key, 'img': img_sort_key, 'audio': audio_sort_key, "keyphrase": kp_sort_key}


__all__ = ['Dataset', 'load_old_vocab', 'get_fields', 'DataReaderBase',
           'filter_example', 'old_style_vocab',
           'build_vocab', 'OrderedIterator',
           'text_sort_key', 'img_sort_key', 'audio_sort_key', 'kp_sort_key',
           'TextDataReader', 'ImageDataReader', 'AudioDataReader', 'KeyphraseDataReader', 'KeyphraseDataset']
