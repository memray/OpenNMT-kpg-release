...
# nus & semeval
nohup python kp_run_eval.py -config config/test/config-rnn-keyphrase.yml -data_dir data/keyphrase/meng17/ -ckpt_dir models/keyphrase/meng17/ -output_dir output/keyphrase/meng17/ -testsets nus semeval -batch_size 64 > output/keyphrase/meng17/kp_run_eval-nus_semeval.log &
# DUC
nohup python kp_run_eval.py -config config/test/config-rnn-keyphrase.yml -data_dir data/keyphrase/meng17/ -ckpt_dir models/keyphrase/meng17/ -output_dir output/keyphrase/meng17/ -testsets duc -batch_size 64 > output/keyphrase/meng17/kp_run_eval-duc.log &
# inspec
nohup python kp_run_eval.py -config config/test/config-rnn-keyphrase.yml -data_dir data/keyphrase/meng17/ -ckpt_dir models/keyphrase/meng17/ -output_dir output/keyphrase/meng17/ -testsets inspec -batch_size 64 > output/keyphrase/meng17/kp_run_eval-inspec.log &
#krapivin
nohup python kp_run_eval.py -config config/test/config-rnn-keyphrase.yml -data_dir data/keyphrase/meng17/ -ckpt_dir models/keyphrase/meng17/ -output_dir output/keyphrase/meng17/ -testsets krapivin -batch_size 64 > output/keyphrase/meng17/kp_run_eval-krapivin.log &
# kp20k_valid2k
nohup python kp_run_eval.py -config config/test/config-rnn-keyphrase.yml -data_dir data/keyphrase/meng17/ -ckpt_dir models/keyphrase/meng17/ -output_dir output/keyphrase/meng17/ -testsets kp20k_valid2k -batch_size 64 > output/keyphrase/meng17/kp_run_eval-kp20k_valid2k.log &
